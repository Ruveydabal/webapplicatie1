                ...
                <div class="login-blok">
                    <div class="login">
                        <div class="login-balk-box">
                            <a class="tekst-login">Sign up</a>
                        </div>
                        <div class="login-balk-box">
                            <div class="login-balk">
                                <form class="login-background" action='register_logic.php' name='register_logic' method='POST'>
                        ...
                        <div class="login-balk-box">
                            <div class="login-balk">
                                <a class="tekst5">Email: </a>
                                <input class="login-background" type='email' name='email' placeholder='email' required>
                            </div>
                        </div>
                        <div class="login-balk-box">
                            <div class="login-balk-klein">
                            <input class="login-background" type='submit' value='register'>
                            </div>
                        </div>
                        </form>
                    </div>
